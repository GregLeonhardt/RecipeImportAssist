...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/recipeimportassist: ../LibTools/dist/Debug/GNU-Linux/liblibtools.a
...
${OBJECTDIR}/DecodeBOF/decode_bof_api.o: DecodeBOF/decode_bof_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeBOF/decode_bof_api.o DecodeBOF/decode_bof_api.c
...
${OBJECTDIR}/DecodeGF2/decode_gf2_api.o: DecodeGF2/decode_gf2_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeGF2/decode_gf2_api.o DecodeGF2/decode_gf2_api.c

${OBJECTDIR}/DecodeGF2/decode_gf2_lib.o: DecodeGF2/decode_gf2_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeGF2
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeGF2/decode_gf2_lib.o DecodeGF2/decode_gf2_lib.c

${OBJECTDIR}/DecodeGRF/decode_grf_api.o: DecodeGRF/decode_grf_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeGRF
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeGRF/decode_grf_api.o DecodeGRF/decode_grf_api.c

${OBJECTDIR}/DecodeGRF/decode_grf_lib.o: DecodeGRF/decode_grf_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeGRF
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeGRF/decode_grf_lib.o DecodeGRF/decode_grf_lib.c

${OBJECTDIR}/DecodeHTML/decode_html_api.o: DecodeHTML/decode_html_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeHTML
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeHTML/decode_html_api.o DecodeHTML/decode_html_api.c

${OBJECTDIR}/DecodeHTML/decode_html_lib.o: DecodeHTML/decode_html_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeHTML
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeHTML/decode_html_lib.o DecodeHTML/decode_html_lib.c

${OBJECTDIR}/DecodeL1/decodel1_api.o: DecodeL1/decodel1_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeL1
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeL1/decodel1_api.o DecodeL1/decodel1_api.c

${OBJECTDIR}/DecodeL1/decodel1_lib.o: DecodeL1/decodel1_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeL1
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeL1/decodel1_lib.o DecodeL1/decodel1_lib.c

${OBJECTDIR}/DecodeL2/decodel2_api.o: DecodeL2/decodel2_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeL2
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeL2/decodel2_api.o DecodeL2/decodel2_api.c

${OBJECTDIR}/DecodeL2/decodel2_lib.o: DecodeL2/decodel2_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeL2
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeL2/decodel2_lib.o DecodeL2/decodel2_lib.c

${OBJECTDIR}/DecodeLIB/decode_api.o: DecodeLIB/decode_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeLIB
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeLIB/decode_api.o DecodeLIB/decode_api.c

${OBJECTDIR}/DecodeLIB/decode_lib.o: DecodeLIB/decode_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeLIB
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeLIB/decode_lib.o DecodeLIB/decode_lib.c

${OBJECTDIR}/DecodeMMF/decode_mmf_api.o: DecodeMMF/decode_mmf_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeMMF
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeMMF/decode_mmf_api.o DecodeMMF/decode_mmf_api.c

${OBJECTDIR}/DecodeMMF/decode_mmf_lib.o: DecodeMMF/decode_mmf_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeMMF
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeMMF/decode_mmf_lib.o DecodeMMF/decode_mmf_lib.c

${OBJECTDIR}/DecodeMX2/decode_mx2_api.o: DecodeMX2/decode_mx2_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeMX2
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeMX2/decode_mx2_api.o DecodeMX2/decode_mx2_api.c

${OBJECTDIR}/DecodeMX2/decode_mx2_lib.o: DecodeMX2/decode_mx2_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeMX2
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeMX2/decode_mx2_lib.o DecodeMX2/decode_mx2_lib.c

${OBJECTDIR}/DecodeMXP/decode_mxp_api.o: DecodeMXP/decode_mxp_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeMXP
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeMXP/decode_mxp_api.o DecodeMXP/decode_mxp_api.c

${OBJECTDIR}/DecodeMXP/decode_mxp_lib.o: DecodeMXP/decode_mxp_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeMXP
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeMXP/decode_mxp_lib.o DecodeMXP/decode_mxp_lib.c

${OBJECTDIR}/DecodeNYC/decode_nyc_api.o: DecodeNYC/decode_nyc_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeNYC
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeNYC/decode_nyc_api.o DecodeNYC/decode_nyc_api.c

${OBJECTDIR}/DecodeNYC/decode_nyc_lib.o: DecodeNYC/decode_nyc_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeNYC
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeNYC/decode_nyc_lib.o DecodeNYC/decode_nyc_lib.c

${OBJECTDIR}/DecodeTXT/decode_txt_api.o: DecodeTXT/decode_txt_api.c
	${MKDIR} -p ${OBJECTDIR}/DecodeTXT
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeTXT/decode_txt_api.o DecodeTXT/decode_txt_api.c

${OBJECTDIR}/DecodeTXT/decode_txt_lib.o: DecodeTXT/decode_txt_lib.c
	${MKDIR} -p ${OBJECTDIR}/DecodeTXT
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecodeTXT/decode_txt_lib.o DecodeTXT/decode_txt_lib.c

${OBJECTDIR}/Encode/encode_api.o: Encode/encode_api.c
	${MKDIR} -p ${OBJECTDIR}/Encode
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Encode/encode_api.o Encode/encode_api.c
...
${OBJECTDIR}/EncodeMXP/encode_mxp_api.o: EncodeMXP/encode_mxp_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EncodeMXP/encode_mxp_api.o EncodeMXP/encode_mxp_api.c

${OBJECTDIR}/EncodeMXP/encode_mxp_lib.o: EncodeMXP/encode_mxp_lib.c
	${MKDIR} -p ${OBJECTDIR}/EncodeMXP
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EncodeMXP/encode_mxp_lib.o EncodeMXP/encode_mxp_lib.c
...
${OBJECTDIR}/EncodeRXF/encode_rxf_api.o: EncodeRXF/encode_rxf_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EncodeRXF/encode_rxf_api.o EncodeRXF/encode_rxf_api.c
...
${OBJECTDIR}/FileScan/filescan_api.o: FileScan/filescan_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileScan/filescan_api.o FileScan/filescan_api.c

${OBJECTDIR}/FileScan/filescan_lib.o: FileScan/filescan_lib.c
	${MKDIR} -p ${OBJECTDIR}/FileScan
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileScan/filescan_lib.o FileScan/filescan_lib.c

${OBJECTDIR}/Recipe/recipe_api.o: Recipe/recipe_api.c
	${MKDIR} -p ${OBJECTDIR}/Recipe
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Recipe/recipe_api.o Recipe/recipe_api.c

${OBJECTDIR}/Recipe/recipe_lib.o: Recipe/recipe_lib.c
	${MKDIR} -p ${OBJECTDIR}/Recipe
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Recipe/recipe_lib.o Recipe/recipe_lib.c

${OBJECTDIR}/Xlate/xlate_api.o: Xlate/xlate_api.c
	${MKDIR} -p ${OBJECTDIR}/Xlate
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Xlate/xlate_api.o Xlate/xlate_api.c

${OBJECTDIR}/Xlate/xlate_lib.o: Xlate/xlate_lib.c
	${MKDIR} -p ${OBJECTDIR}/Xlate
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Xlate/xlate_lib.o Xlate/xlate_lib.c

${OBJECTDIR}/eMail/email_api.o: eMail/email_api.c
	${MKDIR} -p ${OBJECTDIR}/eMail
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eMail/email_api.o eMail/email_api.c

${OBJECTDIR}/eMail/email_lib.o: eMail/email_lib.c
	${MKDIR} -p ${OBJECTDIR}/eMail
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eMail/email_lib.o eMail/email_lib.c

${OBJECTDIR}/main.o: main.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../LibTools/include -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c
