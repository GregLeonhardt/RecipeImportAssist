...
${OBJECTDIR}/EncodeTXT/encode_txt_api.o: EncodeTXT/encode_txt_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EncodeTXT/encode_txt_api.o EncodeTXT/encode_txt_api.c

${OBJECTDIR}/EncodeTXT/encode_txt_lib.o: EncodeTXT/encode_txt_lib.c
	${MKDIR} -p ${OBJECTDIR}/EncodeTXT
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EncodeTXT/encode_txt_lib.o EncodeTXT/encode_txt_lib.c
